...
<form action="{{ route('admin.posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card mb-3">
                <div class="card-header bg-primary text-white fw-bold"><i class="fas fa-paper-plane me-1"></i> Cập Nhật</div>
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary fw-bold"><i class="fas fa-save"></i> Cập Nhật Bài Viết</button>
                    </div>
                </div>
            </div>

            <div class="card">
                <div class="card-header bg-light fw-bold"><i class="fas fa-image me-1"></i> Ảnh Đại Diện</div>
                <div class="card-body text-center">
                    <div class="img-preview mb-2 border bg-light d-flex align-items-center justify-content-center" style="height: 150px; overflow:hidden;">
                        <img id="preview-img" src="{{ asset($post->thumbnail_path ?? 'assets/images/placeholder.jpg') }}" style="max-width: 100%; max-height: 100%;">
                    </div>
